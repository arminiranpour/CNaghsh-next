...
const features = [
  {
    ...
    description:
      "ویدیوهای HLS با پوستر ثابت و کش CDN نمایش داده می‌شوند تا اولین تجربه‌ی بازدید بدون لگ باشد.",
  },
  {
    title: "استخدام شفاف",
    description:
      "آگهی‌ها با اطلاعات پرداخت، شهر، و مهلت انتشار رندر سمت سرور می‌شوند تا قبل از تعامل اولیه قابل مشاهده باشند.",
  },
  {
    title: "مدیریت دسترسی",
    description:
      "صفحات عمومی طی ۵ دقیقه دوباره رندر می‌شوند و هم‌زمان قوانین کش لایه لبه کنترل تغییرات را تضمین می‌کند.",
  },
];
            ...
            <div className="space-y-8 text-center lg:text-right">
              ...
              <div className="space-y-5">
                ...
                <p className="text-lg text-muted-foreground">
                  صفحات خانه، پروفایل، و آگهی‌ها کاملا سمت سرور رندر می‌شوند، تصاویر LCP با{" "}
                  <code className="rounded bg-muted px-2 py-0.5">next/image</code> بارگذاری می‌شوند و اسکریپت‌های غیر ضروری تا بعد از اولین تعامل تعویق دارند.
                </p>
              </div>
